            ...
            <form onSubmit={submit} className="mt-8 space-y-3">
                ...
                <label className="flex items-start gap-2 pt-2 text-sm text-neutral-400">
                    ...
                    <span>
                        ...
                        agree to the VibeRX Terms of Service and Privacy
                        Policy. I understand that my card will only be
                        charged upon provider approval.
                    </span>
                </label>
...
function SubmittedView({ status }) {
    return (
        <GuestLayout>
            ...
            <p className="mt-2 text-center text-sm text-neutral-400">
                A licensed provider will review your submission. You have
                not been charged. We&apos;ll notify you when a decision is
                available.
            </p>
