  ...
  return (
    <GuestLayout>
      ...
      <p className="mt-2 text-center text-sm text-neutral-400">
        Your card may be validated now but is only charged after a licensed
        provider approves your plan and you confirm the final order.
      </p>
      ...
      <form onSubmit={submit} className="mt-8 space-y-4">
        <div>
          <label className={labelClasses}>Cardholder Full Name</label>
          <input
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <div ref={cardExpiryMountRef} className={fieldClasses} />
          </div>
