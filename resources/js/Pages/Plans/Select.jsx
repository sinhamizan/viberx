  ...
  return (
    <GuestLayout>
      ...
      <p className="mt-2 text-center text-sm text-neutral-400">
        Your selection is not a prescription. A licensed provider will review
        your assessment and determine whether treatment is appropriate.
      </p>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-neutral-400">
                    {plan.tagline} · {plan.doses_per_month} doses/month
                  </p>
                </div>
