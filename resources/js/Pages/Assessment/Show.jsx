    ...
    return (
        <GuestLayout>
            ...
            <p className="mt-2 text-center text-sm text-neutral-400">
                Provider-required intake. Conditional questions appear based
                on your answers.
            </p>
            ...
            <form onSubmit={submit} className="mt-8 space-y-8">
                    ...
                    <div className="mt-3 space-y-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={fieldClasses}
                                onChange={(e) =>
                                    setPersonalInfo('sex', e.target.value)
                                }
                            >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <InputError
                                    message={
                                        errors['personal_info.height_in']
                                    }
                                    className="mt-2"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <InputError
                                    message={
                                        errors['personal_info.weight_lb']
                                    }
                                    className="mt-2"
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <InputError
                                message={
                                    errors['personal_info.address_line1']
                                }
                                className="mt-2"
                            />
                        </div>
                    ...
                    <section key={section.key}>
                        ...
                        <div className="mt-3">
                            ...
                            <textarea
                                ...
                                className={fieldClasses}
                                onChange={(e) =>
                                    setNotes(section.key, e.target.value)
                                }
                            />
                            <InputError
                ...
                <section>
                    ...
                    <div className="mt-3 space-y-2">
                        ...
                        <InputError
                            message={
                                errors['health_conditions.conditions']
                            }
                            className="mt-2"
                        />
                    </div>
                ...
                <section>
                    ...
                    <div className="mt-3">
                        ...
                        <textarea
                            ...
                            className={fieldClasses}
                            onChange={(e) =>
                                setNotes('goals', e.target.value)
                            }
                        />
                        <InputError
                            message={errors['goals.notes']}
                            className="mt-2"
                        />
                    </div>
                </section>
